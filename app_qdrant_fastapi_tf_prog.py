...
Install: pip install fastapi uvicorn python-multipart anthropic transformers torch qdrant-client pypdf tqdm
...
class RAGSystem:
    ...
    def add_documents(self, documents: List[str], max_chunk_size: int = 1000):
        ...
        embeddings = self.embedding_model.encode(all_chunks, batch_size=32, show_progress_bar=False)
